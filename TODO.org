...
|      8 |    2 | file byte order ('LE' or 'BE') |
|     10 |    2 | optional field tag             |
|     12 |    2 | optional field size in bytes   |
|     14 |    n | optional field value           |
|    ... |  ... | ...                            |
*** optional fields
| Name     | Purpose                                     |
|----------+---------------------------------------------|
| keyalgo  | key derivation algorithm (i.e. Argon2id)    |
| salt     | random salt for encrypting password         |
| iter     | number of iterations depending on KDF       |
| encalgo  | encryption algorithm (AES, Blowfish, etc)   |
...
| mtime    | modification date/time as Unix time |           | 'MT' | 4    |
| ctime    | creation date/time as Unix time     |           | 'CT' | 4    |
| atime    | access date/time as Unix time       |           | 'AT' | 4    |
