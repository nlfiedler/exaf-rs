...
*** CBOR header size for =LICENSE= example: 155 bytes (macos)
*** CBOR serializer writes the byte vector as 2x actual data size
**** neither =serde_cbor= nor =ciborium= writes =Vec<u8>= as a byte string
**** even if =CS= were written as a byte string, length would be 136 bytes
...
#+begin_src
┌────────┬─────────────────────────┬─────────────────────────┬────────┬────────┐
│00000000│ 45 58 41 46 01 00 00 00 ┊ 00 9b bf 62 4e 4d 67 4c │EXAF•⋄⋄⋄┊⋄××bNMgL│
...
│00000040│ 43 54 1a 60 54 17 8a 62 ┊ 4d 54 1a 66 07 a4 1c 62 │CT•`T•×b┊MT•f•×•b│
│00000050│ 41 54 1a 66 09 fd 0e 62 ┊ 58 41 f6 62 44 49 f6 62 │AT•f_×•b┊XA×bDI×b│
│00000060│ 53 5a 19 04 39 62 4c 4e ┊ 19 02 ab 62 43 41 64 7a │SZ••9bLN┊••×bCAdz│
│00000070│ 73 74 64 62 48 41 64 53 ┊ 48 41 31 62 43 53 94 18 │stdbHAdS┊HA1bCS×•│
│00000080│ fa 18 67 18 91 18 85 18 ┊ a2 18 49 18 ef 18 e2 18 │×•g•×•×•┊×•I•×•×•│
│00000090│ 2d 18 77 18 49 18 21 18 ┊ af 18 87 18 3a 01 18 ef │-•w•I•!•┊×•×•:••×│
│000000a0│ 09 18 ce 01 ff          ┊                         │_•×•×   ┊        │
└────────┴─────────────────────────┴─────────────────────────┴────────┴────────┘
#+end_src
...
**** TODO do not compress files with ~zstd~ if less than ~120~ bytes
