...
*** CBOR is basically a standard for every kind of time
*** custom type header size for =LICENSE= example: 117 bytes (macos)
*** CBOR header size for =LICENSE= example: 140 bytes
*** CBOR serializes the byte vector as 2x actual data size
*** custom format example using =LICENSE=
#+begin_src
┌────────┬─────────────────────────┬─────────────────────────┬────────┬────────┐
│00000000│ 45 58 41 46 01 00 00 00 ┊ 00 75 4e 4d 00 07 4c 49 │EXAF•⋄⋄⋄┊⋄uNM⋄•LI│
...
│00000050│ 07 a4 1c 43 54 00 08 00 ┊ 00 00 00 60 54 17 8a 41 │•×•CT⋄•⋄┊⋄⋄⋄`T•×A│
│00000060│ 54 00 08 00 00 00 00 66 ┊ 09 fd 0e 43 41 00 04 7a │T⋄•⋄⋄⋄⋄f┊_×•CA⋄•z│
│00000070│ 73 74 64 4c 4e 00 08 00 ┊ 00 00 00 00 00 02 ab    │stdLN⋄•⋄┊⋄⋄⋄⋄⋄•× │
#+end_src
...
**** TODO determine lower bound for compressing files (below a certain size it won't help)
